        ...
        <div class="flex flex-col items-end gap-10 mt-12 lg:flex-row">
          <div class="flex-1 w-full lg:w-auto">
            <div class="py-20 text-center bg-indigo-300 h-60">
              ...
              <span
                class="inline-block mt-4 text-xl font-medium tracking-tight text-gray-800 "
              >
          ...
          <div class="flex-1 w-full lg:w-auto">
            <div
              class="py-24 text-center bg-indigo-700 border border-gray-400 shadow-xl  h-72"
            >
              <p class="text-5xl font-black tracking-widest text-white">
                {{ singleProduct.prices[1].amount }}€
              </p>
              <span
                class="inline-block mt-6 text-2xl font-medium tracking-tight text-white "
              >
